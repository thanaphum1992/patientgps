...
$sql = 'SELECT id,CONCAT(pt_pname,pt_fname,pt_lname) as fullname ,
CONCAT(pt_house_no,pt_moo,pt_sub_district,pt_district,pt_province) as fulladdress,
pt_telphone as phone
FROM patient';
...
<head>
    ...
    <title>PatientGPS | Dashboard</title>
    <!-- Font Awesome -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
       ...
       with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="./widget.php" class="nav-link">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2021-<?php echo date("Y"); ?> <a href="#">AdminLTE.io</a>.</strong>
            All rights reserved.
